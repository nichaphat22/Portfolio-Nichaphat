          ...
          <div className="mt-10">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex flex-col items-center justify-center  bg-gray-900 p-2 rounded-xl text-gray-300 md:h-32 w-1/2 cursor-pointer"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center justify-center  bg-gray-900 p-2 rounded-xl text-gray-300 h-32 w-1/2 cursor-pointer"
              >
        ...
        >
          <div className=" bg-gray-900 p-6 rounded-xl text-gray-300">
            ...
            <button
              ...
              className="flex justify-center items-center gap-3 border p-2 w-full rounded-3xl bg-blue-500 cursor-pointer"
            >
